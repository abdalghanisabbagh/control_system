...
class AdminController extends GetxController {
  ...
  Autogenerated usersResModel = Autogenerated();
  ...
  Future<void> getUser() async {
    ...
    ResponseHandler<Autogenerated> responseHandler = ResponseHandler();
    Either<Failure, Autogenerated> response = await responseHandler.getResponse(
      path: AuthLinks.user,
      converter: Autogenerated.fromJson,
