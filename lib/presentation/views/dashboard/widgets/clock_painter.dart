...
class ClockPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawLine(center, Offset(secondX, secondY),
        Paint()..color = ColorManager.bgSideMenu);

// center Dots
    Paint dotPainter = Paint()..color = ColorManager.glodenColor;
    canvas.drawCircle(center, 20, dotPainter);
    canvas.drawCircle(center, 20, Paint()..color = ColorManager.glodenColor);
    canvas.drawCircle(center, 20, dotPainter);
  }
