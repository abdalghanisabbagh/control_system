...
class DistributionScreen extends GetView<DistributionController> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: GetBuilder<DistributionController>(builder: (_) {
        return controller.isLodingGetExamRooms
            ? const Expanded(
                child: Center(
                  ...
                  children: [
                    Row(
                      children: [
                        ...
                        HeaderWidget(
                          text:
                              "Distribution: ${controller.listExamRoom.isEmpty ? "" : controller.listExamRoom.first.controlMission?.name}",
                        ),
                        const Spacer(),
                        InkWell(
                          onTap: () {
                    ...
                    GetBuilder<DistributionController>(
                        builder: (_) => controller.listExamRoom.isEmpty
                            ? Expanded(
                                child: Center(
                                  child: Text(
                                    "No Rooms",
